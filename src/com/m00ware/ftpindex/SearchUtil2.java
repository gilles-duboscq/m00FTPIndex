...
scan:	while(i < searchLen){
	...
	public static void main0(String[] args) throws UnsupportedEncodingException {
		...
		System.out.println(bytesContains("Index de ftp://norace.rez-gif.supelec.fr/Videos/Series/Heroes/".getBytes("ISO-8859-1"), bytes, getLastCharJumps(bytes), getPartialMatchJumps(bytes)));
	}
	...
	public static void main/*1*/(String[] args) throws UnsupportedEncodingException
	{
		String[] strs = new String[] {
				...
				"[15:40]	tu commences à m'énerver toi...aller encore un épisode!!!(plus qu'une dizaine avant la libération lol)avec le serveur",
